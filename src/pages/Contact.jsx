      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-[.85fr_1.15fr] gap-12 lg:gap-20 items-start">
          <div className="lg:sticky lg:top-32">
            ...
            <h1 className="mt-5 text-4xl sm:text-6xl font-black tracking-[-0.055em] leading-[.94] text-white">Let’s find a <span className="text-gradient">useful connection.</span></h1>
            ...
            <div className="mt-9 hidden lg:grid gap-3">
          ...
          <div className="signal-card rounded-[2rem] p-6 sm:p-9 lg:p-10">
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button type="submit" disabled={isSubmitting} className="premium-button w-full py-4 rounded-xl font-bold flex items-center justify-center gap-2 disabled:opacity-50">{isSubmitting ? <><Loader2 className="w-5 h-5 animate-spin"/> Sending…</> : <><Send className="w-4 h-4"/> Start the conversation</>}</button>
