...
import { ArrowLeft, ExternalLink, GithubIcon, Orbit, Star, Languages } from 'lucide-react';
   ...
   <div className="mt-10 grid lg:grid-cols-[1.05fr_.95fr] gap-10 items-start">
    <div>
     ...
     <div className="mt-8 flex flex-wrap gap-3">
      ...
      <a href={repoUrl} target="_blank" rel="noreferrer" className="ghost-button inline-flex items-center gap-2 px-6 py-3.5 rounded-full font-semibold"><GithubIcon className="w-4 h-4"/>Inspect source</a>
     </div>
    </div>
