...
const targets=[...Object.entries(manifest.schemas).map(([name,hash])=>[`../contracts/${name}`,hash]),['../api/generated/portfolio-contracts.js',manifest.generated['generated/javascript/validators.js']]];
...
console.log('Authority Engine portfolio contract integrity: OK');
